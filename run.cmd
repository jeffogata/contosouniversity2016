...
powershell -command "set-item -path env:Path -value $([System.Environment]::GetEnvironmentVariable('Path','Machine')+ ';' + [System.Environment]::GetEnvironmentVariable('Path','User')); dnvm use 1.0.0-rc1-update1 -r clr -a x86; start-process dnx web"
timeout 5
